<?php 
    ...
    $reports = mysql_getdata("SELECT comandas.hist_mesa_numero as tableNumber, comandas.data as openningDate, comandas.hora as openningHour, comandas.hist_valor_fatura as totalValue FROM comandas 
